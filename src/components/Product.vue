...
<div class="overflow-hidden rounded-2xl h-90 lg:w-1/4 md:w-1/2 p-4 w-full product-card scale-on-hover">
    <div class="relative">
      ...
      <button @click="$emit('delete-product')" class="modal-close absolute top-0 right-0 align-middle cursor-pointer flex flex-col items-center mt-4 mr-4 text-white rounded-full bg-black opacity-50 p-2 hidden">
